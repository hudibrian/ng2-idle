...
### This is a fork of the official [ng2-idle](https://github.com/HackedByChinese/ng2-idle) repo, due to the maintainer not being active and updating it to support rxjs6 and angular6.
